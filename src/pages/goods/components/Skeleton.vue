  ...
  <view class="sk-container">
    <scroll-view scroll-y="true" class="viewport viewport" enable-back-to-top="true">
      <view class="goods goods">
        <view class="preview preview">
          <swiper circular="true" current="0" autoplay="false"></swiper>
          <view class="indicator indicator">
            <text class="current sk-transparent sk-opacity">2</text>
        ...
        <view class="meta meta">
          <view class="price price">
            ...
            <text class="number sk-transparent sk-text-14-2857-95 sk-text">79.90</text>
          </view>
          <view class="name ellipsis sk-transparent sk-text-14-2857-832 sk-text"
            >看得见的吸水力速干防潮天然硅藻土地垫</view
          >
          <view class="desc sk-transparent sk-text-0-0000-391 sk-text"
            >防滑防霉，能喝水的天然地垫app</view
          >
        </view>
        <view class="action action">
          <view class="item arrow sk-pseudo sk-pseudo-circle">
            <text class="label sk-transparent sk-text-14-2857-438 sk-text">选择</text>
            <text class="text ellipsis sk-transparent sk-text-14-2857-142 sk-text">
              请选择商品规格
            </text>
          </view>
          <view class="item arrow sk-pseudo sk-pseudo-circle">
            <text class="label sk-transparent sk-text-14-2857-744 sk-text">送至</text>
            <text class="text ellipsis sk-transparent sk-text-14-2857-948 sk-text">
              请选择收获地址
            </text>
          </view>
    ...
    <view class="toolbar toolbar" style="padding-bottom: 0px">
      ...
      <view class="buttons buttons">
        <view
          class="addcart sk-transparent sk-text-31-9444-520 sk-text"
          style="background-position-x: 50%"
        >
          加入购物车
        </view>
        <view
          class="buynow sk-transparent sk-text-31-9444-833 sk-text"
          style="background-position-x: 50%"
        >
          立即购买
        </view>
